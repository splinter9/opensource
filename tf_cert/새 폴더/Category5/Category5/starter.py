...
def solution_model():
    ...
    y_train = x_train[:, -N_FEATURES:]
    y_valid = x_valid[:, -N_FEATURES:]
    ...
    model = tf.keras.models.Sequential([
        tf.keras.layers.LSTM(32, input_shape=(24 , 7),return_sequences=True),
    ...
    model.fit(train_set, epochs=100, validation_data=valid_set, callbacks=[es])
