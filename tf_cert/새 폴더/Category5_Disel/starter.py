...
def solution_model():
    # DO NOT CHANGE THIS CODE
    # Reads the dataset.
    df = pd.read_csv('C:/Users/비트캠프/Desktop/tf_cert/Category5_Disel/Weekly_U.S.Diesel_Retail_Prices.csv', infer_datetime_format=True, index_col='Week of', header=0)
    ...
    model.fit(
        train_set, epochs=1000, validation_data=valid_set, verbose=2, callbacks=[es])

    
    
    mae = model.evaluate(valid_set, verbose=0)
    print('MAE:', mae)
    return model
